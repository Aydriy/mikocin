    ...
    <main className="container">
      ...
      <div className="main__card d-flex row justify-content-center ">
        ...
        <Card
          ...
          color="#e47643"
          num="2"
          srcText="Потере ногтя
          и ампутации
          пальца
          "
          mainText="После полного разрушения ногтя
        ...
        <Card
          ...
          color="#ec5b19"
          num="3"
          srcText="Тяжелому поражению внутренних органов
          "
          mainText="Может привести к повреждениям
